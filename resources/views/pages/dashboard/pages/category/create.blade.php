<x-layouts.dashboard title="Nueva Categoría">
    <div class="max-w-2xl mx-auto animate-slide-up">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-slate-800 tracking-tight">Crear Categoría</h2>
                <p class="mt-0.5 text-sm text-slate-500">Agrega una nueva categoría para organizar tus notas.</p>
            </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="pt-2 flex justify-end">
                        <button type="submit" :disabled="name.trim() === ''"
                            :class="name.trim() === '' ? 'opacity-50 cursor-not-allowed' : 'hover:bg-slate-800 active:scale-[0.98]'"
                            class="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-all duration-200">
